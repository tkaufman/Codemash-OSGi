...
public class RaffleIntegrationTestHelper {
	...
	public static void assertDbFieldsMatch(SimpleJdbcTemplate dbTemplate, Raffle source) {
		Raffle result = (Raffle) dbTemplate.queryForObject(
				"select id, number_of_winners, started from raffles where id = ?",
	...
	public static void flushHibernateSession(SessionFactory factory) {
		SessionFactoryUtils.getSession(factory, false).flush();
	}
}